...
$(".white-popup-checkbox1").click(function() {
    if($(this).is(":checked"))
    {
        window.location.href = "/home-tutors-in-bhopal";
    }
});
$(".white-popup-checkbox2").click(function() {
    if($(this).is(":checked"))
    {
        window.location.href = "/teaching-jobs-in-bhopal";
    }
});
